...
public class BiclooBookmarksFragment extends BicloosFragment implements OnItemLongClickListener, ActionMode.Callback {
	...
	protected AsyncResult<ListAdapter> loadContent(final Context context, final Bundle bundle) {
		...
		final BiclooBookmarkManager biclooBookmarkManager = BiclooBookmarkManager.getInstance();
		...
		final List<Bicloo> favoris = biclooBookmarkManager.getAll(context.getContentResolver());
		try {
