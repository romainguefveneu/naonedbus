...
public class LiveNewsFragment extends CustomListFragment {

	private static final String LOG_TAG = "LiveNewsFragment";
	...
	public void onListItemClick(final ListView l, final View v, final int position, final long id) {
		...
		dialogFragment.show(getChildFragmentManager(), "LiveNewsDetailDialogFragment");
	}
	...
	protected AsyncResult<ListAdapter> loadContent(final Context context, final Bundle bundle) {
		...
		try {
			final LiveNewsManager manager = LiveNewsManager.getInstance();
			final List<LiveNews> commentaires;
			...
			final LiveNewsFomatter fomatter = new LiveNewsFomatter(context);
