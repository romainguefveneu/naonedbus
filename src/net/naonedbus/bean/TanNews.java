...
public class TanNews implements Parcelable, SectionItem {
	...
	public TanNews(final Parcel in) {
		mCode = in.readString();
	...
	@Override
	public TanNews clone() {
		final TanNews clone = new TanNews();
		clone.mCode = mCode;
	...
	public static final Parcelable.Creator<TanNews> CREATOR = new Parcelable.Creator<TanNews>() {
		@Override
		public TanNews createFromParcel(final Parcel in) {
			return new TanNews(in);
		}

		@Override
		public TanNews[] newArray(final int size) {
			return new TanNews[size];
		}
	};
