...
public class RouteTypeProvider extends ReadOnlyContentProvider {

	public static final int TYPESLIGNES = 100;
	public static final int TYPE_ID = 110;

	private static final String AUTHORITY = "net.naonedbus.provider.RouteTypeProvider";
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		queryBuilder.setTables(RouteTypeTable.TABLE_NAME);
		...
		switch (uriType) {
		case TYPE_ID:
			queryBuilder.appendWhere(RouteTypeTable._ID + "=" + uri.getLastPathSegment());
			break;
		case TYPESLIGNES:
			// no filter
			break;
