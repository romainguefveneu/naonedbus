...
public class StopBookmarkViewProvider extends ReadOnlyContentProvider {
	...
	private static final String AUTHORITY = "net.naonedbus.provider.StopBookmarkViewProvider";
	...
	public Cursor query(final Uri uri, final String[] projection, final String selection, final String[] selectionArgs,
		...
		queryBuilder.setTables(StopBookmarkViewTable.TABLE_NAME);

		if (sortOrder == null) {
			sortOrder = StopBookmarkViewTable.ORDER;
		}
		...
		case FAVORI_GROUPES:
			...
			final String where = String.format(StopBookmarkViewTable.WHERE, idGroupes);
