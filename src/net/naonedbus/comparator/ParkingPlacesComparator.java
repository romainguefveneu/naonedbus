 ...
 * 
 */
public class ParkingPlacesComparator implements Comparator<ParkingPublic> {
	...
	public int compare(ParkingPublic parking1, ParkingPublic parking2) {
		...
		return (Integer.valueOf(parking1.getPlacesDisponibles())).compareTo(parking2.getPlacesDisponibles()) * -1;
	}
}
