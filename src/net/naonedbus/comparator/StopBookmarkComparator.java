...
public class StopBookmarkComparator implements Comparator<StopBookmark> {
	...
	public int compare(final StopBookmark favori1, final StopBookmark favori2) {
		...
		if (favori1.getCodeLigne().equals(favori2.getCodeLigne())) {
			final String nom1 = (favori1.getBookmarkName() == null) ? favori1.getName() : favori1.getBookmarkName();
			final String nom2 = (favori2.getBookmarkName() == null) ? favori2.getName() : favori2.getBookmarkName();
