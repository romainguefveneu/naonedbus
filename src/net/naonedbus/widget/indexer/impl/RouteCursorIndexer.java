...
public class RouteCursorIndexer extends CursorSectionIndexer {

	private final String[] mTypes;

	public RouteCursorIndexer(final Cursor cursor, final String[] typesLignes, final String columnSectionName) {
