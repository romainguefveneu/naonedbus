...
public class EquipmentCursorIndexer extends CursorSectionIndexer {

	private final String[] mTypes;

	public EquipmentCursorIndexer(final Cursor cursor, final String[] types, final String columnSectionName) {
