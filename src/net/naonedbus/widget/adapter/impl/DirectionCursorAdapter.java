...
public class DirectionCursorAdapter extends CursorAdapter {
	...
	public DirectionCursorAdapter(Context context, Cursor c, int colorBack) {
		this(context, c);
	}
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		String description = cursor.getString(cursor.getColumnIndex(DirectionTable.DIRECTION_NAME));
