...
public class StopBookmarkArrayAdapter extends ArraySectionAdapter<StopBookmark> {
	...
	public StopBookmarkArrayAdapter(final Context context, final List<StopBookmark> objects) {
	...
	public void bindView(final View view, final Context context, final int position) {
		...
		final StopBookmark item = getItem(position);
